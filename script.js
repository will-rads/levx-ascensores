/* LEVX Ascensores: i18n + interactions */
...
const I18N = {
  en: {
    ...
    "svc1.name": "Maintenance", "svc1.desc": "Preventive plans that keep your elevator safe, compliant and running.",
    "svc2.name": "Repairs", "svc2.desc": "Fast diagnosis and repair for any brand, any age.",
    "svc3.name": "Modernization", "svc3.desc": "New controls, doors and cabins without replacing everything.",
    ...
    "form.phone": "Phone",
    "form.msg": "Your elevator", "form.msgPh": "Address and what is happening",
    "form.send": "Send request",
    "form.note": "Opens your email app with the message pre-filled.",
    "footer.copy": "© 2026 LEVX Ascensores, Spain"
  },
  ...
  es: {
    ...
    "svc1.name": "Mantenimiento", "svc1.desc": "Planes preventivos que mantienen su ascensor seguro, en norma y en marcha.",
    "svc2.name": "Reparaciones", "svc2.desc": "Diagnóstico y reparación rápidos para cualquier marca y antigüedad.",
    "svc3.name": "Modernización", "svc3.desc": "Nuevas maniobras, puertas y cabinas sin sustituirlo todo.",
    ...
    "form.phone": "Teléfono",
    "form.msg": "Su ascensor", "form.msgPh": "Dirección y qué está pasando",
    "form.send": "Enviar solicitud",
    "form.note": "Abre su aplicación de correo con el mensaje ya redactado.",
    "footer.copy": "© 2026 LEVX Ascensores, España"
  },
  ...
  ar: {
    ...
    "svc1.name": "الصيانة", "svc1.desc": "خطط وقائية تُبقي مصعدك آمناً ومطابقاً للمعايير وقيد التشغيل.",
    "svc2.name": "الإصلاحات", "svc2.desc": "تشخيص وإصلاح سريعان لأي ماركة وأي عمر.",
    "svc3.name": "التحديث", "svc3.desc": "لوحات تحكم وأبواب وكبائن جديدة دون استبدال كل شيء.",
    ...
    "form.phone": "الهاتف",
    "form.msg": "مصعدك", "form.msgPh": "العنوان وما الذي يحدث",
    "form.send": "إرسال الطلب",
    "form.note": "يفتح تطبيق البريد لديك والرسالة جاهزة.",
    "footer.copy": "© ٢٠٢٦ LEVX Ascensores، إسبانيا"
  }
};
...
document.getElementById("contactForm").addEventListener("submit", e => {
  e.preventDefault();
  const f = e.target;
  const subject = encodeURIComponent("Audit request, LEVX Ascensores");
